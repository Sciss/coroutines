...
package object coroutines {
  ...
  val COROUTINE_DIRECT_APPLY_ERROR_MESSAGE: String =
  ...
  implicit def coroutine0nothing[R](b: Coroutine._0[Nothing, R]): ~~~>[Nothing, R] =
    new ~~~>[Nothing, R](b)

  implicit def coroutine0[@specialized S, R](b: Coroutine._0[S, R]): ~~~>[S, R] =
    new ~~~>[S, R](b)

  implicit def coroutine1nothing[T, R](b: Coroutine._1[T, Nothing, R]): ~~>[T, (Nothing, R)] =
    new ~~>[T, (Nothing, R)](b)

  implicit def coroutine1[T, @specialized S, R](b: Coroutine._1[T, S, R]): ~~>[T, (S, R)] =
    new ~~>[T, (S, R)](b)
  ...
  implicit def coroutine2[T1, T2, @specialized S, R](b: Coroutine._2[T1, T2, S, R]): ~>[(T1, T2), (S, R)] =
